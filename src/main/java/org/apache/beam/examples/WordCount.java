...
public class WordCount {
  ...
  public static class CountWordsKV
      extends PTransform<PCollection<KV<String, String>>, PCollection<KV<String, Long>>> {
    @Override
    public PCollection<KV<String, Long>> expand(PCollection<KV<String, String>> lines) {



      // Convert lines of text into individual words.
      PCollection<String> words = lines.apply(Keys.create()); // lines.apply(ParDo.of(new ExtractWordsFn()));
  ...
  static void runWordCount(WordCountOptions options) {
    ...
    myHadoopConfiguration.setClass("mapreduce.job.inputformat.class",
            ...
            InputFormat.class);
    myHadoopConfiguration.setClass("key.class", String.class, Object.class);
    myHadoopConfiguration.setClass("value.class", String.class, Object.class);
